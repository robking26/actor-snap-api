...
declare const DescribeProjectsCommand_base: {
    new (input: DescribeProjectsCommandInput): import("@smithy/core/client").CommandImpl<DescribeProjectsCommandInput, DescribeProjectsCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [DescribeProjectsCommandInput]): import("@smithy/core/client").CommandImpl<DescribeProjectsCommandInput, DescribeProjectsCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
