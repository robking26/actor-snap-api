...
declare const ListCollectionsCommand_base: {
    new (input: ListCollectionsCommandInput): import("@smithy/core/client").CommandImpl<ListCollectionsCommandInput, ListCollectionsCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListCollectionsCommandInput]): import("@smithy/core/client").CommandImpl<ListCollectionsCommandInput, ListCollectionsCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
