...
declare const UpdateDatasetEntriesCommand_base: {
    new (input: UpdateDatasetEntriesCommandInput): import("@smithy/core/client").CommandImpl<UpdateDatasetEntriesCommandInput, UpdateDatasetEntriesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateDatasetEntriesCommandInput): import("@smithy/core/client").CommandImpl<UpdateDatasetEntriesCommandInput, UpdateDatasetEntriesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
