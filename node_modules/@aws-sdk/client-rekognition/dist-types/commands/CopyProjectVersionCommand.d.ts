...
declare const CopyProjectVersionCommand_base: {
    new (input: CopyProjectVersionCommandInput): import("@smithy/core/client").CommandImpl<CopyProjectVersionCommandInput, CopyProjectVersionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CopyProjectVersionCommandInput): import("@smithy/core/client").CommandImpl<CopyProjectVersionCommandInput, CopyProjectVersionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
