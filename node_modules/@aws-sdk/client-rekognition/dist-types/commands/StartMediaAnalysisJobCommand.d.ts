...
declare const StartMediaAnalysisJobCommand_base: {
    new (input: StartMediaAnalysisJobCommandInput): import("@smithy/core/client").CommandImpl<StartMediaAnalysisJobCommandInput, StartMediaAnalysisJobCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartMediaAnalysisJobCommandInput): import("@smithy/core/client").CommandImpl<StartMediaAnalysisJobCommandInput, StartMediaAnalysisJobCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
