...
declare const ListUsersCommand_base: {
    new (input: ListUsersCommandInput): import("@smithy/core/client").CommandImpl<ListUsersCommandInput, ListUsersCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListUsersCommandInput): import("@smithy/core/client").CommandImpl<ListUsersCommandInput, ListUsersCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
