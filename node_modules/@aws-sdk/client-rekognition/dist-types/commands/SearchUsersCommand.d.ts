...
declare const SearchUsersCommand_base: {
    new (input: SearchUsersCommandInput): import("@smithy/core/client").CommandImpl<SearchUsersCommandInput, SearchUsersCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SearchUsersCommandInput): import("@smithy/core/client").CommandImpl<SearchUsersCommandInput, SearchUsersCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
