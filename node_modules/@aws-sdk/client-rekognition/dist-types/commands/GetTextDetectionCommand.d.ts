...
declare const GetTextDetectionCommand_base: {
    new (input: GetTextDetectionCommandInput): import("@smithy/core/client").CommandImpl<GetTextDetectionCommandInput, GetTextDetectionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetTextDetectionCommandInput): import("@smithy/core/client").CommandImpl<GetTextDetectionCommandInput, GetTextDetectionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
