...
declare const GetFaceSearchCommand_base: {
    new (input: GetFaceSearchCommandInput): import("@smithy/core/client").CommandImpl<GetFaceSearchCommandInput, GetFaceSearchCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetFaceSearchCommandInput): import("@smithy/core/client").CommandImpl<GetFaceSearchCommandInput, GetFaceSearchCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
