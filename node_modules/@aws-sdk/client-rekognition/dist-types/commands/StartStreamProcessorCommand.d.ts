...
declare const StartStreamProcessorCommand_base: {
    new (input: StartStreamProcessorCommandInput): import("@smithy/core/client").CommandImpl<StartStreamProcessorCommandInput, StartStreamProcessorCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartStreamProcessorCommandInput): import("@smithy/core/client").CommandImpl<StartStreamProcessorCommandInput, StartStreamProcessorCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
