...
declare const StartProjectVersionCommand_base: {
    new (input: StartProjectVersionCommandInput): import("@smithy/core/client").CommandImpl<StartProjectVersionCommandInput, StartProjectVersionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartProjectVersionCommandInput): import("@smithy/core/client").CommandImpl<StartProjectVersionCommandInput, StartProjectVersionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
