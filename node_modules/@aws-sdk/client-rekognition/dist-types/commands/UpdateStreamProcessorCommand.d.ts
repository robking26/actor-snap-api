...
declare const UpdateStreamProcessorCommand_base: {
    new (input: UpdateStreamProcessorCommandInput): import("@smithy/core/client").CommandImpl<UpdateStreamProcessorCommandInput, UpdateStreamProcessorCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: UpdateStreamProcessorCommandInput): import("@smithy/core/client").CommandImpl<UpdateStreamProcessorCommandInput, UpdateStreamProcessorCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
