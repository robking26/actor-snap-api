...
declare const StopProjectVersionCommand_base: {
    new (input: StopProjectVersionCommandInput): import("@smithy/core/client").CommandImpl<StopProjectVersionCommandInput, StopProjectVersionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopProjectVersionCommandInput): import("@smithy/core/client").CommandImpl<StopProjectVersionCommandInput, StopProjectVersionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
