...
declare const DeleteFacesCommand_base: {
    new (input: DeleteFacesCommandInput): import("@smithy/core/client").CommandImpl<DeleteFacesCommandInput, DeleteFacesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteFacesCommandInput): import("@smithy/core/client").CommandImpl<DeleteFacesCommandInput, DeleteFacesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
