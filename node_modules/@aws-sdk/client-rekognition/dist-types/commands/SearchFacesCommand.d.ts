...
declare const SearchFacesCommand_base: {
    new (input: SearchFacesCommandInput): import("@smithy/core/client").CommandImpl<SearchFacesCommandInput, SearchFacesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SearchFacesCommandInput): import("@smithy/core/client").CommandImpl<SearchFacesCommandInput, SearchFacesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
