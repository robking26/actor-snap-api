...
declare const CompareFacesCommand_base: {
    new (input: CompareFacesCommandInput): import("@smithy/core/client").CommandImpl<CompareFacesCommandInput, CompareFacesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CompareFacesCommandInput): import("@smithy/core/client").CommandImpl<CompareFacesCommandInput, CompareFacesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
