...
declare const ListMediaAnalysisJobsCommand_base: {
    new (input: ListMediaAnalysisJobsCommandInput): import("@smithy/core/client").CommandImpl<ListMediaAnalysisJobsCommandInput, ListMediaAnalysisJobsCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListMediaAnalysisJobsCommandInput]): import("@smithy/core/client").CommandImpl<ListMediaAnalysisJobsCommandInput, ListMediaAnalysisJobsCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
