...
declare const GetCelebrityInfoCommand_base: {
    new (input: GetCelebrityInfoCommandInput): import("@smithy/core/client").CommandImpl<GetCelebrityInfoCommandInput, GetCelebrityInfoCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCelebrityInfoCommandInput): import("@smithy/core/client").CommandImpl<GetCelebrityInfoCommandInput, GetCelebrityInfoCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
