...
declare const CreateStreamProcessorCommand_base: {
    new (input: CreateStreamProcessorCommandInput): import("@smithy/core/client").CommandImpl<CreateStreamProcessorCommandInput, CreateStreamProcessorCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateStreamProcessorCommandInput): import("@smithy/core/client").CommandImpl<CreateStreamProcessorCommandInput, CreateStreamProcessorCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
