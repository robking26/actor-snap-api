...
declare const IndexFacesCommand_base: {
    new (input: IndexFacesCommandInput): import("@smithy/core/client").CommandImpl<IndexFacesCommandInput, IndexFacesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: IndexFacesCommandInput): import("@smithy/core/client").CommandImpl<IndexFacesCommandInput, IndexFacesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
