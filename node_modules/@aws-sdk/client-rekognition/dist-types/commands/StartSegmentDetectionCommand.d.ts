...
declare const StartSegmentDetectionCommand_base: {
    new (input: StartSegmentDetectionCommandInput): import("@smithy/core/client").CommandImpl<StartSegmentDetectionCommandInput, StartSegmentDetectionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartSegmentDetectionCommandInput): import("@smithy/core/client").CommandImpl<StartSegmentDetectionCommandInput, StartSegmentDetectionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
