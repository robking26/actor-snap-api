...
declare const ListFacesCommand_base: {
    new (input: ListFacesCommandInput): import("@smithy/core/client").CommandImpl<ListFacesCommandInput, ListFacesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListFacesCommandInput): import("@smithy/core/client").CommandImpl<ListFacesCommandInput, ListFacesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
