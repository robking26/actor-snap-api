...
declare const DescribeProjectVersionsCommand_base: {
    new (input: DescribeProjectVersionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeProjectVersionsCommandInput, DescribeProjectVersionsCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeProjectVersionsCommandInput): import("@smithy/core/client").CommandImpl<DescribeProjectVersionsCommandInput, DescribeProjectVersionsCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
