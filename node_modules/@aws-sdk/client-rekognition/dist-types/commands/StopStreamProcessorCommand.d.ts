...
declare const StopStreamProcessorCommand_base: {
    new (input: StopStreamProcessorCommandInput): import("@smithy/core/client").CommandImpl<StopStreamProcessorCommandInput, StopStreamProcessorCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StopStreamProcessorCommandInput): import("@smithy/core/client").CommandImpl<StopStreamProcessorCommandInput, StopStreamProcessorCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
