...
declare const GetFaceDetectionCommand_base: {
    new (input: GetFaceDetectionCommandInput): import("@smithy/core/client").CommandImpl<GetFaceDetectionCommandInput, GetFaceDetectionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetFaceDetectionCommandInput): import("@smithy/core/client").CommandImpl<GetFaceDetectionCommandInput, GetFaceDetectionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
