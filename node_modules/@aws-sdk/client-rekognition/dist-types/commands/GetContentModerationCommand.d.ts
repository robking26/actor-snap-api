...
declare const GetContentModerationCommand_base: {
    new (input: GetContentModerationCommandInput): import("@smithy/core/client").CommandImpl<GetContentModerationCommandInput, GetContentModerationCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetContentModerationCommandInput): import("@smithy/core/client").CommandImpl<GetContentModerationCommandInput, GetContentModerationCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
