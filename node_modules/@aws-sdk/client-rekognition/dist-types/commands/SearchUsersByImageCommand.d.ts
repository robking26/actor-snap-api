...
declare const SearchUsersByImageCommand_base: {
    new (input: SearchUsersByImageCommandInput): import("@smithy/core/client").CommandImpl<SearchUsersByImageCommandInput, SearchUsersByImageCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SearchUsersByImageCommandInput): import("@smithy/core/client").CommandImpl<SearchUsersByImageCommandInput, SearchUsersByImageCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
