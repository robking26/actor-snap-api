...
declare const StartFaceDetectionCommand_base: {
    new (input: StartFaceDetectionCommandInput): import("@smithy/core/client").CommandImpl<StartFaceDetectionCommandInput, StartFaceDetectionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartFaceDetectionCommandInput): import("@smithy/core/client").CommandImpl<StartFaceDetectionCommandInput, StartFaceDetectionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
