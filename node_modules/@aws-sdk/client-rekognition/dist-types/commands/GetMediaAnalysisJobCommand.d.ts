...
declare const GetMediaAnalysisJobCommand_base: {
    new (input: GetMediaAnalysisJobCommandInput): import("@smithy/core/client").CommandImpl<GetMediaAnalysisJobCommandInput, GetMediaAnalysisJobCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetMediaAnalysisJobCommandInput): import("@smithy/core/client").CommandImpl<GetMediaAnalysisJobCommandInput, GetMediaAnalysisJobCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
