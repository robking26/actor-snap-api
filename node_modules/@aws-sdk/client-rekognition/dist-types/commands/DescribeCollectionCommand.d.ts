...
declare const DescribeCollectionCommand_base: {
    new (input: DescribeCollectionCommandInput): import("@smithy/core/client").CommandImpl<DescribeCollectionCommandInput, DescribeCollectionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DescribeCollectionCommandInput): import("@smithy/core/client").CommandImpl<DescribeCollectionCommandInput, DescribeCollectionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
