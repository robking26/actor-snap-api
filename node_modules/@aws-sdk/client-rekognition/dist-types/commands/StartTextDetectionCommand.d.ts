...
declare const StartTextDetectionCommand_base: {
    new (input: StartTextDetectionCommandInput): import("@smithy/core/client").CommandImpl<StartTextDetectionCommandInput, StartTextDetectionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartTextDetectionCommandInput): import("@smithy/core/client").CommandImpl<StartTextDetectionCommandInput, StartTextDetectionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
