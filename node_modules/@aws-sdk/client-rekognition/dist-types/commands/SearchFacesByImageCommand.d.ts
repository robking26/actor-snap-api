...
declare const SearchFacesByImageCommand_base: {
    new (input: SearchFacesByImageCommandInput): import("@smithy/core/client").CommandImpl<SearchFacesByImageCommandInput, SearchFacesByImageCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: SearchFacesByImageCommandInput): import("@smithy/core/client").CommandImpl<SearchFacesByImageCommandInput, SearchFacesByImageCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
