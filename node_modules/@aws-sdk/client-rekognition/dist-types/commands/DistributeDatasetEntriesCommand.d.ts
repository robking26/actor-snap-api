...
declare const DistributeDatasetEntriesCommand_base: {
    new (input: DistributeDatasetEntriesCommandInput): import("@smithy/core/client").CommandImpl<DistributeDatasetEntriesCommandInput, DistributeDatasetEntriesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DistributeDatasetEntriesCommandInput): import("@smithy/core/client").CommandImpl<DistributeDatasetEntriesCommandInput, DistributeDatasetEntriesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
