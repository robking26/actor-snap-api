...
declare const DeleteProjectVersionCommand_base: {
    new (input: DeleteProjectVersionCommandInput): import("@smithy/core/client").CommandImpl<DeleteProjectVersionCommandInput, DeleteProjectVersionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteProjectVersionCommandInput): import("@smithy/core/client").CommandImpl<DeleteProjectVersionCommandInput, DeleteProjectVersionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
