...
declare const ListDatasetEntriesCommand_base: {
    new (input: ListDatasetEntriesCommandInput): import("@smithy/core/client").CommandImpl<ListDatasetEntriesCommandInput, ListDatasetEntriesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDatasetEntriesCommandInput): import("@smithy/core/client").CommandImpl<ListDatasetEntriesCommandInput, ListDatasetEntriesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
