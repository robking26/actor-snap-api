...
declare const DeleteProjectPolicyCommand_base: {
    new (input: DeleteProjectPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteProjectPolicyCommandInput, DeleteProjectPolicyCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteProjectPolicyCommandInput): import("@smithy/core/client").CommandImpl<DeleteProjectPolicyCommandInput, DeleteProjectPolicyCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
