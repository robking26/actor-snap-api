...
declare const StartFaceSearchCommand_base: {
    new (input: StartFaceSearchCommandInput): import("@smithy/core/client").CommandImpl<StartFaceSearchCommandInput, StartFaceSearchCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartFaceSearchCommandInput): import("@smithy/core/client").CommandImpl<StartFaceSearchCommandInput, StartFaceSearchCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
