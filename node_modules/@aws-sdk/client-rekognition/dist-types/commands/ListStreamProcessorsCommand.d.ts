...
declare const ListStreamProcessorsCommand_base: {
    new (input: ListStreamProcessorsCommandInput): import("@smithy/core/client").CommandImpl<ListStreamProcessorsCommandInput, ListStreamProcessorsCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [ListStreamProcessorsCommandInput]): import("@smithy/core/client").CommandImpl<ListStreamProcessorsCommandInput, ListStreamProcessorsCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
