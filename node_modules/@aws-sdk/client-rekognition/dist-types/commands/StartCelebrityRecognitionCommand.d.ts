...
declare const StartCelebrityRecognitionCommand_base: {
    new (input: StartCelebrityRecognitionCommandInput): import("@smithy/core/client").CommandImpl<StartCelebrityRecognitionCommandInput, StartCelebrityRecognitionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartCelebrityRecognitionCommandInput): import("@smithy/core/client").CommandImpl<StartCelebrityRecognitionCommandInput, StartCelebrityRecognitionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
