...
declare const GetPersonTrackingCommand_base: {
    new (input: GetPersonTrackingCommandInput): import("@smithy/core/client").CommandImpl<GetPersonTrackingCommandInput, GetPersonTrackingCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetPersonTrackingCommandInput): import("@smithy/core/client").CommandImpl<GetPersonTrackingCommandInput, GetPersonTrackingCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
