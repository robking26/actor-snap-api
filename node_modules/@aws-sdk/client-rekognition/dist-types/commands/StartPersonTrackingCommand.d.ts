...
declare const StartPersonTrackingCommand_base: {
    new (input: StartPersonTrackingCommandInput): import("@smithy/core/client").CommandImpl<StartPersonTrackingCommandInput, StartPersonTrackingCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartPersonTrackingCommandInput): import("@smithy/core/client").CommandImpl<StartPersonTrackingCommandInput, StartPersonTrackingCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
