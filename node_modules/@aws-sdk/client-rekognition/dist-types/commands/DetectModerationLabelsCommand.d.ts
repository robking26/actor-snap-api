...
declare const DetectModerationLabelsCommand_base: {
    new (input: DetectModerationLabelsCommandInput): import("@smithy/core/client").CommandImpl<DetectModerationLabelsCommandInput, DetectModerationLabelsCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetectModerationLabelsCommandInput): import("@smithy/core/client").CommandImpl<DetectModerationLabelsCommandInput, DetectModerationLabelsCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
