...
declare const ListDatasetLabelsCommand_base: {
    new (input: ListDatasetLabelsCommandInput): import("@smithy/core/client").CommandImpl<ListDatasetLabelsCommandInput, ListDatasetLabelsCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListDatasetLabelsCommandInput): import("@smithy/core/client").CommandImpl<ListDatasetLabelsCommandInput, ListDatasetLabelsCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
