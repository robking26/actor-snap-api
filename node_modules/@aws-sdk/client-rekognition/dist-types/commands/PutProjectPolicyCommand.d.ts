...
declare const PutProjectPolicyCommand_base: {
    new (input: PutProjectPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutProjectPolicyCommandInput, PutProjectPolicyCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: PutProjectPolicyCommandInput): import("@smithy/core/client").CommandImpl<PutProjectPolicyCommandInput, PutProjectPolicyCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
