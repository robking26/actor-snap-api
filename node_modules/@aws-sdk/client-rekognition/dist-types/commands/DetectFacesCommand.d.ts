...
declare const DetectFacesCommand_base: {
    new (input: DetectFacesCommandInput): import("@smithy/core/client").CommandImpl<DetectFacesCommandInput, DetectFacesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DetectFacesCommandInput): import("@smithy/core/client").CommandImpl<DetectFacesCommandInput, DetectFacesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
