...
declare const DeleteStreamProcessorCommand_base: {
    new (input: DeleteStreamProcessorCommandInput): import("@smithy/core/client").CommandImpl<DeleteStreamProcessorCommandInput, DeleteStreamProcessorCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteStreamProcessorCommandInput): import("@smithy/core/client").CommandImpl<DeleteStreamProcessorCommandInput, DeleteStreamProcessorCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
