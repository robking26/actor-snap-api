...
declare const GetCelebrityRecognitionCommand_base: {
    new (input: GetCelebrityRecognitionCommandInput): import("@smithy/core/client").CommandImpl<GetCelebrityRecognitionCommandInput, GetCelebrityRecognitionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: GetCelebrityRecognitionCommandInput): import("@smithy/core/client").CommandImpl<GetCelebrityRecognitionCommandInput, GetCelebrityRecognitionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
