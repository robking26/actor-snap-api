...
declare const DeleteCollectionCommand_base: {
    new (input: DeleteCollectionCommandInput): import("@smithy/core/client").CommandImpl<DeleteCollectionCommandInput, DeleteCollectionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: DeleteCollectionCommandInput): import("@smithy/core/client").CommandImpl<DeleteCollectionCommandInput, DeleteCollectionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
