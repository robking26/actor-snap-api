...
declare const ListProjectPoliciesCommand_base: {
    new (input: ListProjectPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListProjectPoliciesCommandInput, ListProjectPoliciesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: ListProjectPoliciesCommandInput): import("@smithy/core/client").CommandImpl<ListProjectPoliciesCommandInput, ListProjectPoliciesCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
