...
declare const CreateCollectionCommand_base: {
    new (input: CreateCollectionCommandInput): import("@smithy/core/client").CommandImpl<CreateCollectionCommandInput, CreateCollectionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: CreateCollectionCommandInput): import("@smithy/core/client").CommandImpl<CreateCollectionCommandInput, CreateCollectionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
