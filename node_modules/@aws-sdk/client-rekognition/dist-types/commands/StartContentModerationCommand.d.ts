...
declare const StartContentModerationCommand_base: {
    new (input: StartContentModerationCommandInput): import("@smithy/core/client").CommandImpl<StartContentModerationCommandInput, StartContentModerationCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (input: StartContentModerationCommandInput): import("@smithy/core/client").CommandImpl<StartContentModerationCommandInput, StartContentModerationCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
