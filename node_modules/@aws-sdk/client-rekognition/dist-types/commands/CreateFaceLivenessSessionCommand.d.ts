...
declare const CreateFaceLivenessSessionCommand_base: {
    new (input: CreateFaceLivenessSessionCommandInput): import("@smithy/core/client").CommandImpl<CreateFaceLivenessSessionCommandInput, CreateFaceLivenessSessionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
    new (...[input]: [] | [CreateFaceLivenessSessionCommandInput]): import("@smithy/core/client").CommandImpl<CreateFaceLivenessSessionCommandInput, CreateFaceLivenessSessionCommandOutput, import("..").RekognitionClientResolvedConfig, import("..").ServiceInputTypes, import("..").ServiceOutputTypes>;
